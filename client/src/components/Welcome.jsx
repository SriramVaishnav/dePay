      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
          <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">
            Send Crypto <br /> across the world in seconds
          </h1>
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
            An open source, decentralized, peer-to-peer, crypto currency exchange platform built on Ethereum.
          </p>
          <button
              type="button"
            ...
            {false
              ...
              : (
                <button
                  ...
                  className="text-white w-auto mt-2 py-2 px-5 bg-[#6555df] hover:bg-[#885fc6] rounded-2xl cursor-pointer"
                >
                  Send now
                </button>
              )}
